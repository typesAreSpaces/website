...
:END:
** Optimality proof of Farey's sequence
:PROPERTIES:
:EXPORT_FILE_NAME: proof_optimality_farey
:EXPORT_DATE:
:END:
[[http://www.johndcook.com/blog/2010/10/20/best-rational-approximation/][John Cook's post]]
** About Dickson's lemma and rewriting
:PROPERTIES:
:EXPORT_FILE_NAME: about_dickson_lemma_rewriting
:EXPORT_DATE:
:END:
...
** Formalization of $\neg \neg (A \lor \neg A)$ in Lean
:PROPERTIES:
:EXPORT_FILE_NAME: not_not_lem
:EXPORT_DATE: 2022-08-20
:END:
The first time I saw the following exercise was in [[https://www.youtube.com/watch?v=OMzxl1c6pSo][OPLSS 2015]]. A proof using the axiomatization of intuitionistic logic is the following:
...
:END:
#+INCLUDE: "./not_not_introduction_intuitionistic_prop_logic/abstract.org"
#+INCLUDE: "./not_not_introduction_intuitionistic_prop_logic/introduction.org"
#+INCLUDE: "./not_not_introduction_intuitionistic_prop_logic/prekripke.org"
#+INCLUDE: "./not_not_introduction_intuitionistic_prop_logic/kripke.org"
** My first post: how to make posts and academic websites using Hugo with the academic theme
:PROPERTIES:
...
of the process so I can recall the necessary steps if I have to start from scratch again. This website was `rendered` using the [[https://gohugo.io/][hugo]] static website generator and a special theme called [[https://academic-demo.netlify.app][academic]].

Most of the help I got comes from [[http://www.statslab.cam.ac.uk/~qz280/post/migrating/][this post]]; it does a pretty good job describing some technical details of the hugo framework and its organization. Thus, the intention of this post is to provide and overview and quick configuration tips which aren't covered by the aforementioned post.

#+INCLUDE: "./first_post/tools.org"
#+INCLUDE: "./first_post/basic-editing.org"
#+INCLUDE: "./first_post/workflow.org"
